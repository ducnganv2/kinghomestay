<?php
  ...
  define('SITE_URL', 'http://localhost/KingHomestay/');
  ...
  define('UPLOAD_IMAGE_PATH',$_SERVER['DOCUMENT_ROOT'].'/KingHomestay/images/');
...
function send_mail($email, $subject, $message)
{
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'hoxuanhung2802@gmail.com'; 
        $mail->Password   = 'hjqa rotr vios ajui'; 
